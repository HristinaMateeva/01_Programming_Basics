class PizzaDelivery:
    ...
    def add_extra(self, ingredient: str, quantity: int, price_per_quantity: float):
        ...
        if ingredient not in self.ingredients:
            ...
            price_product = quantity * price_per_quantity
            self.price += price_product
        else:
            self.ingredients[ingredient] += quantity
            price_for_increase = quantity * price_per_quantity
            self.price += price_for_increase
    ...
    def remove_ingredient(self, ingredient: str, quantity: int, price_per_quantity: float):
        ...
        self.ingredients[ingredient] -= quantity
        price_for_decrease = quantity * price_per_quantity
        self.price -= price_for_decrease
